...
There are a variety of commercial support options available for Eclipse Temurin. A number of support providers are listed below. It's important to note that none of these providers have been evaluated or are officially endorsed by the Adoptium(R) project. Each commercial support provider tends to cater to different typical use-cases, so it is recommended that you evaluate each option carefully based on your specific needs and requirements.
